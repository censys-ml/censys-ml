...
function encode_RSA_exponent(str)
    if str ~= nil and str ~= '' and str ~= ' ' then
        str = tonumber(str)
--        print(str)
        result = {[2] = 0, [3] = 0, [5] = 0, [17] = 0, [257] = 0, [65537] = 0}
        result[str] = 1
        return result
    else
        return {
...
function encode_ecdsa_length(str)
    if str ~= nil and str ~= '' and str ~= ' ' then
        str = tonumber(str)
        result = {[256] = 0, [384] = 0, [521] = 0}
        result[str] = 1
        return result
    else
        return {[256] = nil, [384] = nil, [521] = nil}
    end
end
